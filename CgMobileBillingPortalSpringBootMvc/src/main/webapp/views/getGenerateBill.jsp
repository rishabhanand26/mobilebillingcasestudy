...
<form action="showGenerateBill" style="max-width:500px;margin:auto" align="right-side">
  <div class ="input-container"><h2><font color="#ee6e73">join us! Talk more with your beloved.</h2></div>
  <div class="input-container">
  
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="Customer ID " name="customerID">
  </div>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="mobileNo" name="mobileNo">
  </div>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="text" placeholder="Bill Month" name="billMonth">
  </div>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="Used Local SMS" name="noOfLocalSMS">
  </div>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="Used Std SMS" name="noOfStdSMS">
  </div>
   <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="Used Internet Data Usage Units" name="internetDataUsageUnits">
  </div>
   <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="Used Local Calls" name="noOfLocalCalls">
  </div>
   <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="Used Std Call " name="noOfStdCalls">
  </div>
  </div class="input-container">
