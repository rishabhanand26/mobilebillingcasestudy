...
<form action="showBillDetails" style="max-width:500px;margin:auto" align="right-side">
  ...
  <div class="input-container">
    <i class="fa fa-user icon"></i>
    <input class="input-field" type="number" placeholder="Mobile Number" name="mobileNo">
  </div>
  <div class="input-container">
    <i class="fa fa-user icon"></i>
